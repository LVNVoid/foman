...
CREATE TABLE "StoreSettings" (
    ...
    "contactPhone" TEXT DEFAULT '+62 21 1234 5678',
    "contactAddress" TEXT DEFAULT 'Jl. Contoh No. 123, Jakarta',
    "googleMapsEmbedUrl" TEXT,
    "openDays" TEXT NOT NULL DEFAULT 'Senin - Jumat',
    "openHours" TEXT NOT NULL DEFAULT '08:00 - 17:00',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
