...
export function Navbar({ storeName }: { storeName?: string }) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/95 border-b backdrop-blur supports-backdrop-filter:bg-background/80">
      {/* Top Bar - Desktop Only */}
      <div
        className={`hidden lg:block scroll-hide w-full bg-primary border-b overflow-hidden transition-all duration-300 ease-in-out ${
          scrolled ? 'h-0 opacity-0' : 'h-8 opacity-100'
        }`}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-6 text-xs font-medium text-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 sm:h-20 items-center justify-between gap-2 sm:gap-4">
          <Link
            href="/"
            className="flex items-center gap-1.5 sm:gap-4 group shrink-0"
          >
            <Image
              src="/logo-foman.png"
              alt="Foman Kreasi"
              ...
              priority
            />
            <span className="text-[18px] md:text-xl tracking-tight font-bold">
              Foman<span className="text-primary">Kreasi</span>
            </span>
          </Link>
